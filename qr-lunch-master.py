...
# ---------------------------------------------------------------------------------------------
pietro="4a"
zeton=pietro+'q'+id_zetonu+'q'+data_zetonu+'q'+WierszGodZetonu(pietro)+'q'+ile_zetonow_dziennie_max+'q'+dostawcy[0]
...
# print 'debug +++++++++++++++++'+"Ciąg dla kodu QR: " + ''.join(tab_kod[c] if c in tab_kod else c for c in zeton)
